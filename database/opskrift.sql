...
--
-- Host: mysql74.unoeuro.com
-- Generation Time: Dec 16, 2021 at 10:44 PM
...
--
-- Database: `davidosbeck_dk_db`
--

-- --------------------------------------------------------

--
-- Table structure for table `opskrift`
--

CREATE TABLE `opskrift` (
  `opskId` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `opskrift`
--
...
--
-- Indexes for table `opskrift`
--
ALTER TABLE `opskrift`
  ADD PRIMARY KEY (`opskId`);
...
--
-- AUTO_INCREMENT for table `opskrift`
--
ALTER TABLE `opskrift`
  MODIFY `opskId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
COMMIT;
