    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-3">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Indtast et navn til sedlen</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <label for="navn-input"></label>
                <input class="input-field list__name__field bg-transparent mb-4 w-100" id="navn-input" placeholder="Fx Aftensmad">
            </div>
            <div class="modal-footer">
                <button type="button" class="secondary-btn bg-transparent px-5 me-2" data-bs-dismiss="modal">Anuller</button>
                <button type="button" class="start makelist main-btn px-5 ms-2" data-bs-dismiss="modal">Ok</button>
            </div>
        </div>
    </div>
</div>
