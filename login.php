...
<section class="main">
    <div class="main__login container">
        <form action="" class="login-register" id="login">
            <label for="email-input" class="login__label fw-light">Email</label>
            <div class="input-field mb-3">
                ...
                <input type="email" class="login-input input" placeholder="Email" id="email-input">
            </div>

            <label for="password-input" class="login__label fw-light">Kodeord</label>
            <div class="input-field">
                ...
                <input type="password" class="login-input input" placeholder="Kodeord" id="password-input">
                <i class="far fa-eye login-hide" id="login-hide"></i>
            </div>

            <a href="#" class="login__forgot text-decoration-none">Glemt din adgangskode?</a>

            <a class="text-decoration-none" href="ingredienser.php">
